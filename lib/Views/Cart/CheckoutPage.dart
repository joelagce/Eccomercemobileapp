                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        child: TextFrave(text: personalBloc.state.address == null ? 'Add' : 'Change', color: kPrimaryColor, fontSize: 18 ),
                    ...
                    children: [
                      ...
                      GestureDetector(
                        child: BlocBuilder<CartBloc, CartState>(
                          builder: (context, state) 
                            => ( !state.cardActive )
                            ? TextFrave(text: 'Add', color: kPrimaryColor, fontSize: 18 )
                            : TextFrave(text: 'Change', color: kPrimaryColor, fontSize: 18 )
                        ),
